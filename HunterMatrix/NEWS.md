...
HunterMatrix 1.5.0 includes the following improvements and changes:

### Major changes

- Added checks to determine if an OLE2-based Microsoft Office document is
  encrypted.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1295)
...
- Added the ability to record URLs found in HTML if the generate-JSON-metadata
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1281)

- Added regex support for the `clamd.conf` `OnAccessExcludePath` config option.
  This change courtesy of GitHub user b1tg.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1314)
...
- Added FIPS-compliant CVD signing/verification with external `.sign` files.
  ...
  HunterMatrix now installs a 'certs' directory in the app config directory
  ...
  Added two new APIs to the public huntermatrix.h header:
    ```c
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1417)
...
- Set a limit on the max-recursion config option. Users will no longer be
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1264)
...
- Build system: CMake improvements to support compiling for the AIX platform.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1387)

- Improve support for extracting malformed zip archives.
  This change is courtesy of Frederick Sell.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1460)

- Windows: Code quality improvement for the ClamScan and ClamDScan `--move`
  and `--remove` options.
  This change is courtesy of Maxim Suhanov.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1470)
...
- Added file type recognition for some kinds of AI model files.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1476)

### Bug fixes

- Technical debt: Reduced email multipart message parser complexity.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1347)
...
- Fixed possible undefined behavior in inflate64 module.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1469)
...
- Fixed a bug in ClamD that broke reporting of memory usage on Linux.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1465)

- Windows: Fix a build issue when the same library dependency is found in
  two different locations.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1453)

- Fix an infinite loop when scanning some email files in debug-mode.
  This fix is courtesy of Yoann Lecuyer
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1445)
...
HunterMatrix 1.4.0 includes the following improvements and changes:

### Major changes

- Added support for extracting ALZ archives.
  The new HunterMatrix file type for ALZ archives is `CL_TYPE_ALZ`.
  Added a [DCONF](https://docs.huntermatrix.net/manual/Signatures/DynamicConfig.html)
  option to enable or disable ALZ archive support.
  > _Tip_: DCONF (Dynamic CONFiguration) is a feature that allows for some
  > configuration changes to be made via HunterMatrix `.cfg` "signatures".
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1183)

- Added support for extracting LHA/LZH archives.
  The new HunterMatrix file type for LHA/LZH archives is `CL_TYPE_LHA_LZH`.
  Added a [DCONF](https://docs.huntermatrix.net/manual/Signatures/DynamicConfig.html)
  option to enable or disable LHA/LZH archive support.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1192)
...
- Added the ability to disable image fuzzy hashing, if needed. For context,
  ...
  New libhuntermatrix scan options:
  ```c
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1186)

### Other improvements

- Added cross-compiling instructions for targeting ARM64/aarch64 processors for
  [Windows](https://github.com/Cisco-Talos/huntermatrix/blob/main/INSTALL-cross-windows-arm64.md)
  and
  [Linux](https://github.com/Cisco-Talos/huntermatrix/blob/main/INSTALL-cross-linux-arm64.md).
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1116)
...
- Improved the Freshclam warning messages when being blocked or rate limited
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1195)
...
- Removed unnecessary memory allocation checks when the size to be allocated
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1137)
...
- Improved the Freshclam documentation to make it clear that the `--datadir`
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1199)
...
- Added an optimization to avoid calculating the file hash if the clean file
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1167)

- Added an improvement to the SystemD service file for ClamOnAcc so that the
  service will shut down faster on some systems.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1164)
...
- Added a CMake build dependency on the version map files so that the build
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1294)
...
- Added an improvement to the CMake build so that the RUSTFLAGS settings
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1301)

### Bug fixes

- Silenced confusing warning message when scanning some HTML files.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1252)

- Fixed minor compiler warnings.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1197)

- Since the build system changed from Autotools to CMake, HunterMatrix no longer
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1217)

- Fixed assorted typos. Patch courtesy of RainRat.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1228)

- Added missing documentation for the ClamScan `--force-to-disk` option.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1186)

- Fixed an issue where HunterMatrix unit tests would prefer an older
  libclamunrar_iface library from the install path, if present, rather than
  the recently compiled library in the build path.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1258)
...
- Fixed a build issue on Windows with newer versions of Rust.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1307)

- Fixed an unaligned pointer dereference issue on select architectures.
  Fix courtesy of Sebastian Andrzej Siewior.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1293)
...
- Fixed a bug that prevented loading plaintext (non-CVD) signature files
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1309)
...
HunterMatrix 1.3.1 is a critical patch release with the following fixes:
...
- [CVE-2024-20380](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-20380):
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1242)
...
- Updated select Rust dependencies to the latest versions.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1227)

- Fixed a bug causing some text to be truncated when converting from UTF-16.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1230)

- Fixed assorted complaints identified by Coverity static analysis.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1235)
...
- Fixed a bug causing CVDs downloaded by the `DatabaseCustomURL` Freshclam
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1238)

- Added the new 'valhalla' database name to the list of optional databases in
  preparation for future work.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1238)

- Added symbols to the `libhuntermatrix.map` file to enable additional build
  configurations.

  Patch courtesy of Neil Wilson.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1244)

## 1.3.0

HunterMatrix 1.3.0 includes the following improvements and changes:
...
- Added support for extracting and scanning attachments found in Microsoft
  ...
  c. The libhuntermatrix scan option `options.parse &= ~CL_SCAN_PARSE_ONENOTE;`,
  d. A signature change to the `daily.cfg` dynamic configuration (DCONF).
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1048)

### Other improvements

- Fixed issue when building HunterMatrix on the Haiku (BeOS-like) operating system.
  Patch courtesy of Luca D'Amico
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1061)
...
- ClamD: When starting, ClamD will now check if the directory specified by
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1037)

- CMake: If configured to build static libraries, CMake will now also
  install the libhuntermatrix_rust, libclammspack, libclamunrar_iface, and
  libclamunrar static libraries required by libhuntermatrix.
  ...
  build some other program that uses the libhuntermatrix static library.

  Patch courtesy of driverxdw.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1100)
...
- Added file type recognition for compiled Python (`.pyc`) files.
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1111)

- Improved support for decrypting PDF's with empty passwords.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1141)
...
- Fixed a warning when scanning some HTML files.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1084)

- Fixed an issue decrypting some PDF's with an empty password.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1079)

- ClamOnAcc: Fixed an infinite loop when a watched directory does not exist.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1047)

- ClamOnAcc: Fixed an infinite loop when a file has been deleted before a scan.
  Patch courtesy of gsuehiro.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1150)

- Fixed a possible crash when processing VBA files on HP-UX/IA 64bit.
  Patch courtesy of Albert Chin-A-Young.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/526)
...
- ClamConf: Fixed an issue printing `MaxScanSize` introduced with the change
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1121)

- Fixed an issue building a HunterMatrix RPM in some configurations.
  The issue was caused by faulty CMake logic that intended to create an
  empty database directory during the install.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1144)
...
HunterMatrix 1.2.3 is a critical patch release with the following fixes:

- Updated select Rust dependencies to the latest versions.
  This resolved Cargo audit complaints and included PNG parser bug fixes.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1226)

- Fixed a bug causing some text to be truncated when converting from UTF-16.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1231)

- Fixed assorted complaints identified by Coverity static analysis.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1236)

- Fixed a bug causing CVDs downloaded by the `DatabaseCustomURL` Freshclam
  config option to be pruned and then re-downloaded with every update.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1239)
...
- Silenced a warning "Unexpected early end-of-file" that occured when
  ...
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1215)

## 1.2.2

HunterMatrix 1.2.2 is a critical patch release with the following fix:
...
- [CVE-2024-20328](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-20328):
  ...
  of HunterMatrix's ClamD service.
...
HunterMatrix 1.2.1 is a patch release with the following fixes:

- Eliminate security warning about unused "atty" dependency.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1033

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.12.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1056

- Build system: Fix link error with Clang/LLVM/LLD version 17.
  Patch courtesy of Yasuhiro Kimura.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1060

- Fixed the alert-exceeds-max feature for files greater than 2 GiB and less
  than max file size.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1039
...
HunterMatrix 1.2.0 includes the following improvements and changes:
...
- Added support for extracting Universal Disk Format (UDF) partitions.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/941

- Added an option to customize the size of HunterMatrix's clean file cache.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/882
...
- Introduced a SystemD timer for running Freshclam updates, without sending
  ...
  ```sh
  sudo systemctl enable --now huntermatrix-freshclam-once.timer
  sudo systemctl list-timers
  sudo systemctl status huntermatrix-freshclam-once.timer
  sudo systemctl status huntermatrix-freshclam-once.service
  journalctl -u huntermatrix-freshclam-once.service
  ```
  If you want a different update interval you can edit the timer unit file:
  ```sh
  sudo systemctl edit huntermatrix-freshclam-once.timer
  ```
  Patch courtesy of Nils Werner.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/962
...
- Raised the MaxScanSize limit so the total amount of data scanned when
  ...
  The `MaxFileSize` is still limited internally in HunterMatrix to 2 gigabytes.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/945
...
- Added ability for Freshclam to use a client certificate PEM file and a
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/955
...
- Fix an issue extracting files from ISO9660 partitions where the files are
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/938

- CMake build system improvement to support compiling with OpenSSL 3.x on
  macOS with the Xcode toolchain.

  The official HunterMatrix installers and packages are now built with OpenSSL 3.1.1
  or newer.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/970
...
- The suggested path for the `clamd.pid` and `clamd.sock` file in the sample
  ...
  - `/run/huntermatrix/clamd.pid`
  - `/run/huntermatrix/clamd.sock`

  For consistency, it now specifies `clamd.sock` instead of `clamd.socket`.

  Patch courtesy of computersalat.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/931

### Bug fixes

- Fixed an issue where HunterMatrix does not abort the signature load process after
  partially loading an invalid signature. The bug would later cause a crash when
  scanning certain files.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/934

- Fixed a possible buffer over-read bug when unpacking PE files.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/927

- Removed a warning message showing the HTTP response codes during the
  Freshclam database update process.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/935

- Added missing command line options to the ClamD and HunterMatrix-Milter `--help`
  message and manpages.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/936

- ClamOnAcc: Fixed error message when using `--wait` without `--ping` option.
  Patch courtesy of Răzvan Cojocaru.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/984

- Fixed an assortment of code quality issues identified by Coverity:
  - GitHub pull requests:
    - https://github.com/Cisco-Talos/huntermatrix/pull/989
    - https://github.com/Cisco-Talos/huntermatrix/pull/998
...
- Windows: Fixed a build issue with the CMake-Rust integration regarding
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/992

- Fixed a bounds check issue in the PDF parser that may result in a 1-byte
  buffer over read but does not cause a crash.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/988

- Upgraded the bundled UnRAR library (libclamunrar) to version 6.2.10.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1008

- Fixed a compatibility issue with libjson-c version 0.17.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1002
...
HunterMatrix 1.1.3 is a patch release with the following fixes:

- Eliminate security warning about unused "atty" dependency.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1034

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.12.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1055

- Windows: libjson-c 0.17 compatibility fix. with ssize_t type definition.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1063

- Build system: Fix link error with Clang/LLVM/LLD version 17.
  Patch courtesy of Yasuhiro Kimura.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1059

- Fix alert-exceeds-max feature for files > 2GB and < max-filesize.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1040
...
HunterMatrix 1.1.2 is a critical patch release with the following fixes:

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.10.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1011

## 1.1.1

HunterMatrix 1.1.1 is a critical patch release with the following fixes:
...
- Fixed a build issue when using the Rust nightly toolchain, which was
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/997

- Fixed a build issue on Windows when using Rust version 1.70 or newer.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/994
...
- CMake build system improvement to support compiling with OpenSSL 3.x on
  ...
  The official HunterMatrix installers and packages are now built with OpenSSL 3.1.1
  or newer.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/972

- Removed a warning message showing the HTTP response codes during the
  Freshclam database update process.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/939
...
HunterMatrix 1.1.0 includes the following improvements and changes:

### Major changes

- Added the ability to extract images embedded in HTML CSS `<style>` blocks.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/813

- Updated to Sigtool so that the `--vba` option will extract VBA code from
  Microsoft Office documents the same way that libhuntermatrix extracts VBA.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/852
...
- Added a new ClamScan and ClamD option: `--fail-if-cvd-older-than=days`.
  ...
  number of days.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/867

- Added a new function `cl_cvdgetage()` to the libhuntermatrix API.
...
- Added a new function `cl_engine_set_clcb_vba()` to the libhuntermatrix API.
  ...
  extraction logic that HunterMatrix uses to scan documents.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/852
...
- Removed the vendored TomsFastMath library in favor of using OpenSSL to
  ...
  Work courtesy of Sebastian Andrzej Siewior.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/840
...
- Build system: Added CMake option `DO_NOT_SET_RPATH` to avoid setting
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/815

- Build system: Enabled version-scripts with CMake to limit symbol exports for
  libhuntermatrix, libfreshclam, libclamunrar_iface, and libclamunrar shared
  libraries on Unix systems, excluding macOS.
  Improvement courtesy of Orion Poplawski and Sebastian Andrzej Siewior.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/776
...
- Build system: Enabled users to pass in custom Rust compiler flags using the
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/835
...
- Removed a hard-coded alert for CVE-2004-0597.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/855

- Set Git attributes to prevent Git from altering line endings for Rust
  vendored libraries. Third-party Rust libraries are bundled in the HunterMatrix
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/800

- Fixed compile time warnings.
  Improvement courtesy of Răzvan Cojocaru.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/795

- Added a minor optimization when matching domain name regex signatures for
  PDB, WDB and CDB type signatures.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/837
...
- Build system: Enabled the ability to select a specific Python version.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/787

- Added improvements to the ClamOnAcc process log output so that it is
  easier to diagnose bugs.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/822

- Windows: Enabled the MSI installer to upgrade between feature versions more
  easily when HunterMatrix is installed to a location different from the default
  (i.e., not `C:\Program Files\HunterMatrix`). This means that the MSI installer can
  find a previous HunterMatrix 1.0.x installation to upgrade to HunterMatrix 1.1.0.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/872
...
- Fixed the broken `ExcludePUA` / `--exclude-pua` feature.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/780

- Fixed an issue with integer endianness when parsing Windows executables on
  big-endian systems.
  Fix courtesy of Sebastian Andrzej Siewior.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/814

- Fixed a possible stack overflow read when parsing WDB signatures.
  This issue is not a vulnerability.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/807

- Fixed a possible index out of bounds when loading CRB signatures.
  This issue is not a vulnerability.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/810

- Fixed a possible use after free when reading logical signatures.
  This issue is not a vulnerability.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/811

- Fixed a possible heap overflow read when reading PDB signatures.
  This issue is not a vulnerability.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/812

- Fixed a possible heap overflow read in javascript normalizer module.
  This issue is not a vulnerability.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/868
...
- Fixed two bugs that would cause Freshclam to fail update when applying a
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/893

- Fixed an assortment of complaints identified by Coverity static analysis.
  - GitHub pull requests:
    - https://github.com/Cisco-Talos/huntermatrix/pull/891
    - https://github.com/Cisco-Talos/huntermatrix/pull/899
...
- Fixed one of the Freshclam tests that was failing on some Fedora systems
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/881

- Correctly remove temporary files generated by the VBA and XLM extraction
  modules so that the files are not leaked in patched versions of HunterMatrix
  where temporary files are written directly to the temp-directory instead
  of writing to a unique subdirectory.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/894
...
HunterMatrix 1.0.6 is a critical patch release with the following fixes:

- Updated select Rust dependencies to the latest versions.
  This resolved Cargo audit complaints and included PNG parser bug fixes.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1225)

- Fixed a bug causing some text to be truncated when converting from UTF-16.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1232)

- Fixed assorted complaints identified by Coverity static analysis.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1237)

- Fixed a bug causing CVDs downloaded by the `DatabaseCustomURL` Freshclam
  config option to be pruned and then re-downloaded with every update.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1240)
...
- Silenced a warning "Unexpected early end-of-file" that occured when
  scanning some PNG files.
  - [GitHub pull request](https://github.com/Cisco-Talos/huntermatrix/pull/1216)

## 1.0.5

HunterMatrix 1.0.5 is a critical patch release with the following fixes:
...
HunterMatrix 1.0.4 is a patch release with the following fixes:

- Eliminate security warning about unused "atty" dependency.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1035

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.12.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1054

- Windows: libjson-c 0.17 compatibility fix. with ssize_t type definition.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1064

- Freshclam: Removed a verbose warning printed for each Freshclam HTTP request.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1042

- Build system: Fix link error with Clang/LLVM/LLD version 17.
  Patch courtesy of Yasuhiro Kimura.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1058

- Fix alert-exceeds-max feature for files > 2GB and < max-filesize.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1041
...
HunterMatrix 1.0.3 is a critical patch release with the following fixes:

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.10.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1010

## 1.0.2

HunterMatrix 1.0.2 is a critical patch release with the following fixes:
...
- Fixed a build issue when using the Rust nightly toolchain, which was
  affecting the oss-fuzz build environment used for regression tests.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/996

- Fixed a build issue on Windows when using Rust version 1.70 or newer.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/993
...
- CMake build system improvement to support compiling with OpenSSL 3.x on
  ...
  The official HunterMatrix installers and packages are now built with OpenSSL 3.1.1
  or newer.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/973

- Fixed an issue where HunterMatrix does not abort the signature load process after
  partially loading an invalid signature.
  The bug would later cause a crash when scanning certain files.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/952

- Fixed an issue so that HunterMatrix correctly removes temporary files generated
  by the VBA and XLM extraction modules so that the files are not leaked in
  patched versions of HunterMatrix where temporary files are written directly to the
  temp-directory instead of writing to a unique subdirectory.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/900

- Set Git attributes to prevent Git from altering line endings for bundled Rust
  libraries. Third-party Rust libraries are bundled in the HunterMatrix release
  ...
  ensures that the hashes are correct.
  Improvement courtesy of Nicolas R.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/856

- Fixed two bugs that would cause Freshclam to fail update when applying a
  CDIFF database patch if that patch adds a file to the database archive
  or removes a file from the database archive.
  This bug also caused Sigtool to fail to create such a patch.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/901
...
HunterMatrix 1.0.1 is a critical patch release with the following fixes:
...
- Fix allmatch detection issue with the preclass bytecode hook.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/825

- Update vendored libmspack library to version 0.11alpha.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/828
...
HunterMatrix 1.0.0 includes the following improvements and changes.
...
- Support for decrypting read-only OLE2-based XLS files that are encrypted with
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/700
...
- Overhauled the implementation of the all-match feature. The newer code is more
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/687
...
- Added a new callback to the public API for inspecting file content during a
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/170
...
- Added a new function to the public API for unpacking CVD signature archives.
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/690

- The option to build with an external TomsFastMath library has been removed.
  HunterMatrix requires non-default build options for TomsFastMath to support bigger
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/742

- Moved the Dockerfile and supporting scripts from the main HunterMatrix repository
  over to a new repository: https://github.com/Cisco-Talos/huntermatrix-docker

  The separate repository will make it easier to update the images and fix
  issues with images for released HunterMatrix versions.

  Any users building the HunterMatrix Docker image rather than pulling them from
  Docker Hub will have to get the latest Docker files from the new location.

  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/764

- Increased the SONAME major version for libhuntermatrix because of ABI changes
  between the 0.103 LTS release and the 1.0 LTS release.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/778

### Other improvements

- Add checks to limit PDF object extraction recursion.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/629
...
- Increased the limit for memory allocations based on untrusted input and
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/723

- Dramatically improved the build time of libhuntermatrix-Rust unit tests.
  The unit test build is included in the time limit for the test itself and was
  timing out on slower systems. The HunterMatrix Rust code modules now share the same
  build directory, which also reduces the amount of disk space used for the
  build.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/694
...
- For Windows: The debugging symbol (PDB) files are now installed alongside the
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/669
...
- Relaxed the constraints on the check for overlapping ZIP file entries so as
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/561
...
- Added explicit minimum and maximum supported LLVM versions so that the build
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/692

- Moved the HunterMatrix Docker files for building containers to a new Git repository.
  The Docker files are now in https://github.com/Cisco-Talos/huntermatrix-docker.
  ...
  directly to files in the HunterMatrix release branches.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/764

- Fixed compiler warnings that may turn into errors in Clang 16.
  Patch courtesy of Michael Orlitzky.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/767
...
- Allow building with a custom RPATH so that the executables may be moved after
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/768
...
- Assorted code quality fixes. These are not security issues and will not be
  ...
  - Several heap buffer overflows while loading PDB and WDB databases were found
    ...
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/530
    - Follow-up Optimization: https://github.com/Cisco-Talos/huntermatrix/pull/712

  - oss-fuzz 43843: heap buffer overflow read (1) cli_sigopts_handler
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/560

  - oss-fuzz 44849: heap buffer overflow read (4) in HTML/js-norm
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/503

  - oss-fuzz 43816: heap buffer overflow read (8) in cli_bcomp_freemeta
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/583

  - oss-fuzz 43832: heap buffer overflow read (2) in cli_parse_add
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/611

  - oss-fuzz 44493: integer overflow in cli_scannulsft
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/554

  - CIFuzz leak detected in IDB parser
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/547

  - oss-fuzz assorted signature parser leaks
    - GitHub pull requests:
      - https://github.com/Cisco-Talos/huntermatrix/pull/532
      - https://github.com/Cisco-Talos/huntermatrix/pull/533
      - https://github.com/Cisco-Talos/huntermatrix/pull/535

  - oss-fuzz 40601: leak detected in pdf_parseobj
    - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/553

- Fixed a build failure when using LIBHUNTERMATRIX_ONLY mode with tests enabled.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/714

- Fixed an issue verifying EXE/DLL authenticode signatures to determine a given
  file can be trusted (skipped).
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/727

- Fixed a caching bug relating to the Container and Intermediates logical
  signature condition.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/724
...
- Fixed a build issue when build with RAR disabled or when building with an
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/672

- Fixed the capitalization of the `-W` option for `clamonacc` in the `clamonacc`
  manpage. Patch courtesy of GitHub user monkz.
  - GitHub pull requests:
    - https://github.com/Cisco-Talos/huntermatrix/pull/709
    - https://github.com/Cisco-Talos/huntermatrix/pull/710

- macOS: Fixed an issue with memory-map (`mmap`) system call detection affecting
  versions 0.105 and 0.104. Memory maps may be used in HunterMatrix to improve
  signature load performance and scan performance, as well as RAM usage.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/705
...
- Fixed a performance issue with Rust code when the build type is not explicitly
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/701

- Fixed an issue loading Yara rules containing regex strings with an escaped
  forward-slash (`\/`) followed by a colon (`:`).
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/696
...
- Fixed the default bytecode timeout value listed in the manpages and in the
  ...
  - GitHub pull requests:
    - https://github.com/Cisco-Talos/huntermatrix/pull/631
    - https://github.com/Cisco-Talos/huntermatrix/pull/661

- Fixed an issue building the libhuntermatrix_rust test program when running `ctest`
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/572
...
- Fixed an issue where scans sent to `clamd` with the all-match mode enabled
  ...
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/741

- Fixed bug when starting `clamonacc` with the `--log=FILE` option that created
  randomly named files in the current directory.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/751
...
HunterMatrix 0.105.2 is a critical patch release with the following fixes:
...
- Fixed an issue loading Yara rules containing regex strings with an escaped
  forward-slash (`\/`) followed by a colon (`:`).
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/695
...
- Moved the HunterMatrix Docker files for building containers to a new Git repository.
  ...
  scripts used to publish and update the images without committing changes
  directly to files in the HunterMatrix release branches.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/765

- Update vendored libmspack library to version 0.11alpha.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/829
...
HunterMatrix 0.105.1 is a critical patch release with the following fixes:
...
HunterMatrix 0.105.0 includes the following improvements and changes.

### New Requirements

- Starting with HunterMatrix v0.105, the Rust toolchain is required to compile HunterMatrix.
  ...
  Building HunterMatrix requires, at a minimum, Rust compiler version 1.61, as it
  relies on features introduced in the Rust 2021 Edition.

  HunterMatrix's third-party Rust library dependencies are vendored into the release
  tarball (`huntermatrix-<version>.tar.gz`) file that we publish on
  [huntermatrix.net/downloads](https://www.huntermatrix.net/downloads).
...
- Added image fuzzy hash subsignatures for logical signatures.
  ...
  HunterMatrix's image fuzzy hash is very close to, but not 100% identical to, the
  ...
  HunterMatrix's image fuzzy hashes are not expected to match the fuzzy hashes
  ...
  - Added a process memory scanning feature from ClamWin's ClamScan.
    ...
    * `--unload`
    ...
    - Gianluigi Tiesi for allowing us to integrate the Windows process memory
      scanning feature from ClamWin into the HunterMatrix.
...
- Updated the LLVM bytecode runtime support so that it can use LLVM versions
  ...
  For details about building HunterMatrix with the LLVM bytecode runtime, see the
...
- The `libclamunrar.so` library's SO version now matches that of `libhuntermatrix.so`.
  The upstream UnRAR library does not have an SO version that we should match.
  This change is to prevent a possible collision when multiple HunterMatrix versions
  are installed.
...
- Rewrote the HunterMatrix database archive incremental-update feature (CDIFF) from
...
- [CVE-2022-20771](CVE-2022-20771): Fixed a possible infinite loop vulnerability
  ...
  libhuntermatrix it is the "CL_SCAN_HEURISTIC_BROKEN_MEDIA" scan option.
  Thank you to Michał Dardas for reporting this issue.
...
HunterMatrix 0.104.4 is a critical patch release with the following fixes:
...
HunterMatrix 0.104.3 is a critical patch release with the following fixes:
...
HunterMatrix 0.104.2 is a critical patch release with the following fixes:
...
- [CVE-2022-20698](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-20698):
  ...
  Affects 0.104.1, 0.103.4 and prior when HunterMatrix is compiled with libjson-c and
...
- Fixed ability to disable the file size limit with libhuntermatrix C API, like this:
  ```c
...
- Increased the maximum line length for HunterMatrix config files from 512 bytes to
...
HunterMatrix 0.104.1 is a critical patch release with the following fixes:
...
HunterMatrix 0.104.0 includes the following improvements and changes.

### New Requirements

- As of HunterMatrix 0.104, CMake is required to build HunterMatrix.
...
- The built-in LLVM for the bytecode runtime has been removed.
  ...
  as it was in HunterMatrix 0.103.

  We wished to add support for newer versions of LLVM but ran out of time.
  If you're building HunterMatrix from source and you wish to use LLVM instead of the
...
- There are now official HunterMatrix images on Docker Hub.

  > _Note_: Until HunterMatrix 0.104.0 is released, these images are limited to
  > "unstable" versions, which are updated daily with the latest changes in the
  > default branch on GitHub.

  You can find the images on [Docker Hub under `huntermatrix`](https://hub.docker.com/r/huntermatrix/huntermatrix).

  Docker Hub HunterMatrix tags:

  - `huntermatrix/huntermatrix:<version>`: A release preloaded with signature databases.

    Using this container will save the HunterMatrix project some bandwidth.
  ...
  - `huntermatrix/huntermatrix:<version>_base`: A release with no signature databases.

    Use this container **only** if you mount a volume in your container under
    `/var/lib/huntermatrix` to persist your signature database databases.
    This method is the best option because it will reduce data costs for HunterMatrix
  ...
  You can use the `unstable` version (i.e. `huntermatrix/huntermatrix:unstable` or
  `huntermatrix/huntermatrix:unstable_base`) to try the latest from our development branch.
  ...
  the larger HunterMatrix database images on a regular basis.

  For more details, see
  [the HunterMatrix Docker documentation](https://docs.huntermatrix.net/manual/Installing/Docker.html).

  Special thanks to Olliver Schinagl for his excellent work creating HunterMatrix's
...
- Added CL_TYPE_TIFF, CL_TYPE_JPEG types to match GIF, PNG typing behavior.
  ...
  HunterMatrix does not yet have BMP or JPEG 2000 format checking capabilities.

- Added progress callbacks to libhuntermatrix for:
  ...
  compile, and unload progress. See `huntermatrix.h` for API details.
...
- Trusted SHA256-based Authenticode hashes can now be loaded in from *.cat
  ...
  [Authenticode documentation](https://docs.huntermatrix.net/appendix/Authenticode.html)
...
The HunterMatrix team thanks the following individuals for their code submissions:
...
HunterMatrix 0.103.11 is a patch release with the following fixes:

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.12.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1053

- Windows: libjson-c 0.17 compatibility fix. with ssize_t type definition.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1065

- Windows: Update build system to use OpenSSL 3 and PThreads-Win32 v3.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1057

## 0.103.10

HunterMatrix 0.103.10 is a critical patch release with the following fixes:

- Upgrade the bundled UnRAR library (libclamunrar) to version 6.2.10.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/1009

## 0.103.9

HunterMatrix 0.103.9 is a critical patch release with the following fixes:
...
- Fixed compiler warnings that may turn into errors in Clang 16.
  Patch courtesy of Michael Orlitzky.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/747
...
HunterMatrix 0.103.8 is a critical patch release with the following fixes:
...
- Update vendored libmspack library to version 0.11alpha.
  - GitHub pull request: https://github.com/Cisco-Talos/huntermatrix/pull/830
...
HunterMatrix 0.103.7 is a critical patch release with the following fixes:
...
HunterMatrix 0.103.6 is a critical patch release with the following fixes:
...
HunterMatrix 0.103.5 is a critical patch release with the following fixes:
...
HunterMatrix 0.103.4 is a critical patch release with the following fixes:
...
- Fixed a crash in programs that use libhuntermatrix when the programs don't set a
...
- Added checks to the SIS archive parser to prevent an SIS file entry from
  ...
  infinite loop, as HunterMatrix's scan recursion limit limits the depth of nested
  archive extraction.
...
HunterMatrix 0.103.3 is a patch release with the following fixes:
...
- Renamed the `mirrors.dat` file to `freshclam.dat`.
  ...
  were offline. HunterMatrix now uses a paid CDN instead of a mirror network, and the
  new FreshClam DAT file no longer stores that kind of information.
  The UUID used in HunterMatrix's HTTP User-Agent is stored in the FreshClam DAT file
...
- Disabled the `HTTPUserAgent` config option if the `DatabaseMirror` uses
  huntermatrix.net. This will prevent users from being inadvertently blocked and
  will ensure that we can keep better metrics on which HunterMatrix versions are
  being used.
...
HunterMatrix 0.103.2 is a security patch release with the following fixes:
...
- FreshClam: Deprecate the `SafeBrowsing` config option.
  ...
  For more details, see:
  https://blog.huntermatrix.net/2020/06/the-future-of-huntermatrix-safebrowsing.html
...
HunterMatrix 0.103.1 is a patch release with the following fixes and improvements.
...
- Fixed PNG parser logic bugs that caused an excess of parsing errors and fixed
  ...
  HunterMatrix version 0.103.0 to mitigate the effects from these bugs.
...
HunterMatrix 0.103.0 includes the following improvements and changes.
...
- The DLP module has been enhanced with additional credit card ranges and a new
  engine option which allows HunterMatrix to alert only on credit cards (and not, for
...
- `clamdtop.exe` now available for Windows users. Functionality is somewhat
  ...
  build `clamdtop.exe` for HunterMatrix on Windows.
...
- Added new *experimental* CMake build tooling. CMake is not yet recommended for
  ...
  detailed instructions on how to build HunterMatrix with CMake.
...
- Improvements to the layout and legibility of temp files created during a
  ...
  into how HunterMatrix analyzes a given file and can also be useful to analysts for
...
- Loosened the curl version requirements in order to build and use `clamonacc`.
  You may now build HunterMatrix with any version of libcurl. However `clamonacc`'s
...
- Fixed clamd, huntermatrix-milter, and freshclam to create PID files before
...
- Fixed Trusted & Revoked Windows executable (PE) file signature rules (.crb)
  ...
  minimum FLEVEL. These signatures enable HunterMatrix to trust executables that
  ...
  or disable signatures at load time depending on the current HunterMatrix version.

- Fixed a bug wherein you could not build HunterMatrix with `--enable-libhuntermatrix-only`
...
- Autotools (automake, autoconf, m4, pkg-config, libtool) are now required in
  ...
  you compile HunterMatrix, run `autogen.sh`.
...
HunterMatrix 0.102.4 is a bug patch release to address the following issues.
...
- [CVE-2020-3327](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-3327):
  Fix a vulnerability in the ARJ archive parsing module in HunterMatrix 0.102.3 that
...
- [CVE-2020-3481](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-3481):
  Fix a vulnerability in the EGG archive module in HunterMatrix 0.102.0 - 0.102.3
  ...
  This vulnerability is mitigated for those using the official HunterMatrix
...
HunterMatrix 0.102.3 is a bug patch release to address the following issues.

- [CVE-2020-3327](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-3327):
  Fix a vulnerability in the ARJ archive parsing module in HunterMatrix 0.102.2 that
...
- [CVE-2020-3341](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-3341):
  Fix a vulnerability in the PDF parsing module in HunterMatrix 0.101 - 0.102.2 that
...
HunterMatrix 0.102.2 is a bug patch release to address the following issues.
...
- Re-applied a fix to alleviate file access issues when scanning RAR files in
  downstream projects that use libhuntermatrix where the scanning engine is operating
...
HunterMatrix 0.102.1 is a security patch release to address the following issues.
...
- Build system fixes to build huntermatrix-milter, to correctly link with libxml2 when
...
- Introduced a new configure option to statically link libjson-c with libhuntermatrix.
  Static linking with libjson is highly recommended to prevent crashes in
  applications that use libhuntermatrix alongside another JSON parsing library.
...
HunterMatrix 0.102.0 includes an assortment improvements and a couple of significant
changes.
...
- The On-Access Scanning feature has been migrated out of `clamd` and into
  ...
  `clamdscan` and `huntermatrix-milter` in that it acts as a client to `clamd`.
  ...
  refer to the user manual on [HunterMatrix.net](https://docs.huntermatrix.net/),
...
- The documentation has moved!
  - Users should navigate to [HunterMatrix.net](https://docs.huntermatrix.net/)
  ...
  - The new home for the documentation markdown is in our
    [HunterMatrix FAQ GitHub repository](https://github.com/Cisco-Talos/huntermatrix-faq)
- To remediate future denial of service conditions caused by excessive scan times,
  ...
  Libhuntermatrix users may customize the time limit using the `cl_engine_set_num`
...
- Re-formatted the entire HunterMatrix code-base using `clang-format` in conjunction
  with our new HunterMatrix code style specification. See the
  [huntermatrix.net blog post](https://blog.huntermatrix.net/2019/02/huntermatrix-adopts-clang-format.html)
  for details.
- Integrated HunterMatrix with Google's [OSS-Fuzz](https://github.com/google/oss-fuzz)
...
- Significantly reduced number of warnings generated when compiling HunterMatrix with
  "-Wall" and "-Wextra" compiler flags and made many subtle improvements to the
  consistency of variable types throughout the code.
- Updated the majority of third-party dependencies for HunterMatrix on Windows.
  The source code for each has been removed from the huntermatrix-devel repository.
  This means that these dependencies have to be compiled independently of HunterMatrix.
  The added build process complexity is offset by significantly reducing the
  difficulty of releasing HunterMatrix with newer versions of those dependencies.
- During the 0.102 development period, we've also improved our Continuous
  ...
  to the HunterMatrix Git repository. This chains together our build and quality
  assurance test suites and enables automatic testing of all proposed changes
  to HunterMatrix, with customizable parameters to suit the testing needs of any
  given code change.
- Added a new `huntermatrix-version.h` generated header to provide version number
  macros in text and numerical format for HunterMatrix, libhuntermatrix, and libfreshclam.
...
- Libcurl has become a hard-dependency. Libcurl enables HTTPS support for
  ...
  and `clamd`.
- Libcurl version >= 7.45 is required when building HunterMatrix from source with
...
HunterMatrix 0.101.5 is a security patch release that addresses the following issues.
...
HunterMatrix 0.101.4 is a security patch release that addresses the following issues.

- An out of bounds write was possible within HunterMatrix's NSIS bzip2 library when
  ...
  Thanks to Martin Simmons for reporting the issue [here](https://bugzilla.huntermatrix.net/show_bug.cgi?id=12371)
...
- The zip bomb vulnerability mitigated in 0.101.3 has been assigned the
  ...
  resolves HunterMatrix's vulnerability to CVE-2019-12625.
...
HunterMatrix 0.101.3 is a patch release to address a vulnerability to non-recursive
zip bombs.
...
Thank you to Hanno Böck for reporting the issue as it relates to HunterMatrix,
[here](https://bugzilla.huntermatrix.net/show_bug.cgi?id=12356).
...
HunterMatrix 0.101.2 is a patch release to address a handful of security related bugs.

This patch release is being released alongside the 0.100.3 patch so that users
who are unable to upgrade to 0.101 due to libhuntermatrix API changes are protected.
...
- Removed use of problematic feature that converted file descriptors to
  ...
  This feature caused issues in environments where the HunterMatrix engine is run
...
HunterMatrix 0.101.1 is an urgent patch release to address an issue in 0.101.0
specifically for developers that depend on libhuntermatrix.

The issue in 0.101.0 is that `huntermatrix.h` required supporting headers that were
not provided on `make install`.

To address this issue, the internal `cltypes.h` header has been replaced by
a `huntermatrix-types.h` that is generated on `./configure` and will be installed
alongside `huntermatrix.h`.

### Other changes

- Increased the default CommandReadTimeout to reduce the chance of mail loss
  if using huntermatrix-milter with the TCP socket. Contribution by Scott Kitterman.
...
HunterMatrix 0.101.0 is a feature release with an assortment of improvements that
...
- Our user manual has been converted from latex/pdf/html into **Markdown**!
  ...
  [Check it out!](https://github.com/Cisco-Talos/huntermatrix-devel/blob/dev/0.101/docs/UserManual.md)
...
- Libhuntermatrix API changes:
  - The following scanning functions now require a filename argument.
    This will enable HunterMatrix to report more details warning and error
  ...
  - Scanning options have been converted from a single flag bit-field into
    ...
    As a result, the API changes will require libhuntermatrix users to modify
    how they initialize and pass scan options into calls such as `cl_scandesc()`.
    For details:
    - [example code](https://github.com/Cisco-Talos/huntermatrix-devel/blob/dev/0.101/examples/ex1.c#L89)
    - [documentation](https://github.com/Cisco-Talos/huntermatrix-devel/blob/dev/0.101/docs/UserManual/libhuntermatrix.md#data-scan-functions)
...
- `clamd.conf` and command line interface (CLI) changes:
  - As in 0.100.2, the clamd.conf `OnAccessExtraScanning` has been temporarily
    ...
    For details, see: https://bugzilla.huntermatrix.net/show_bug.cgi?id=12048
...
- Upgrade from libmspack 0.5alpha to libmspack 0.7.1alpha. As a reminder, we
  ...
  HunterMatrix-provided version of libmspack provides additional abilities to parse
...
- Included the config filename when reporting errors parsing HunterMatrix configs.
  GitHub pull-request by Josh Soref.
- Improvement to build scripts for huntermatrix-milter.
  GitHub pull-request by Renato Botelho.

### Other changes

- Removed option handler for `AllowSupplementaryGroups` from libfreshclam.
  This option was previously deprecated from freshclam in HunterMatrix 0.100.0 but
...
As you might imagine, HunterMatrix is much more than just the tarball or EXE you
...
- Test Frameworks
  - Feature Testing:
    Throughout the development of HunterMatrix 0.101, our quality assurance engineers
    have been hard at work rebuilding our QA automation framework in Python from
    the ground up to test HunterMatrix features on 32-and-64bit versions:
...
- Signature Database Distribution:
  During the course of HunterMatrix 0.101 development, our web and ops teams have been
  ...
  help us continue to improve HunterMatrix.

  We are of course grateful to all of the community members who have donated
  their server bandwidth to mirror the HunterMatrix signature databases over the
  years. Thank-you so much!

- Development Processes:
  As many of you know, HunterMatrix 0.100 was in development for a good two years.
  ...
  and more responsive HunterMatrix development cycles.

  HunterMatrix 0.101 is the first of many smaller feature releases where we created
  ...
  We're very proud of HunterMatrix 0.101 and we hope you enjoy it.
...
HunterMatrix 0.100.2 is a patch release to address a set of vulnerabilities.

- Fixes for the following HunterMatrix vulnerabilities:
  - [CVE-2018-15378](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-15378):
    Vulnerability in HunterMatrix's MEW unpacking feature that could allow an
    unauthenticated, remote attacker to cause a denial of service (DoS)
    condition on an affected device.
    Reported by Secunia Research at Flexera.
  - Fix for a 2-byte buffer over-read bug in HunterMatrix's PDF parsing code.
...
Thank you to the following HunterMatrix community members for your code submissions
and bug reports!
...
HunterMatrix 0.100.1 is a hotfix release to patch a set of vulnerabilities.

- Fixes for the following CVE's:
  - [CVE-2017-16932](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-16932):
    Vulnerability in libxml2 dependency (affects HunterMatrix on Windows only).
  ...
  - [CVE-2018-0361](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-0361):
    HunterMatrix PDF object length check, unreasonably long time to parse relatively
...
HunterMatrix 0.100.0 is a feature release which includes many code submissions
 from the HunterMatrix community. As always, it can be downloaded from our downloads
 page on huntermatrix.net. Some of the more prominent submissions include:

- Interfaces to the Prelude SIEM open source package for collecting
  HunterMatrix virus events.
- Support for Visual Studio 2015 for Windows builds. Please note that we
  ...
  we no longer test HunterMatrix on Windows XP or Vista.
...
- Deprecation of the AllowSupplementaryGroups parameter statement
  in clamd, huntermatrix-milter, and freshclam. Use of supplementary
...
HunterMatrix 0.100, including but not limited to:
...
- Deprecating internal LLVM code support. The configure script has changed
  ...
  libraries, and to otherwise use the bytecode interpreter for HunterMatrix
...
- Fixes to HunterMatrix's Container system and the introduction of Intermediates
...
HunterMatrix has an active issue queue and enjoys continual improvement but as sad as
 ...
 setting up HunterMatrix:

- Platform: macOS:
  - Bug:  If you attempt to build HunterMatrix with a system installed LLVM you may
...
HunterMatrix 0.99.4 is a hotfix release to patch a set of vulnerabilities.
...
Thank you to the following HunterMatrix community members for your code
...
HunterMatrix 0.99.3 is a hotfix release to patch a set of vulnerabilities.
...
HunterMatrix 0.99.2 is a release of bug fixes and minor enhancements.

- fix ups improving the reliability of several HunterMatrix file parsers.
...
- clamd refinements of open file limitations on Solaris. Patch by
  Jim Morris
- huntermatrix-milter signal handling for improved clean up during
  termination.
...
HunterMatrix 0.99.1 contains a new feature for parsing Hancom Office files
including extracting and scanning embedded objects. HunterMatrix 0.99.1
...
HunterMatrix 0.99 contains major new features and changes. YARA rules,
Perl Compatible Regular Expressions, revamped on-access scanning
for Linux, and other new features join the many great features of HunterMatrix:

- Processing of YARA rules(some limitations- see signatures.pdf).
- Support in HunterMatrix logical signatures for many of the features
...
- A new HunterMatrix API callback function that is invoked when a virus
...
- Windows installation directories changed from \Program Files\Sourcefire\
  HunterMatrix to \Program Files\HunterMatrix or \Program Files\HunterMatrix-x64.
...
adjustments before using HunterMatrix 0.99. Users of windows binaries need to be
aware of the change of installation directories.

Thank you to the HunterMatrix community members who sent patches and bug reports
included for HunterMatrix 0.99:
...
HunterMatrix 0.98.7 is here! This release contains new scanning features
and bug fixes.
...
and sample submission from the HunterMatrix community members:
...
Thanks to the following HunterMatrix community members for code submissions
and bug reporting included in HunterMatrix 0.98.6:
...
Welcome to HunterMatrix 0.98.5! HunterMatrix 0.98.5 includes important new features
for collecting and analyzing file properties. Software developers and
analysts may collect file property meta data using the HunterMatrix API for
subsequent analysis by HunterMatrix bytecode programs. Using these features
...
HunterMatrix API and bytecode facilities for collecting and analyzing file
properties.

HunterMatrix 0.98.5 also includes these new features and bug fixes:

- Support for the XDP file format and extracting, decoding, and
  scanning PDF files within XDP files.
- Addition of shared library support for LLVM versions 3.1 - 3.5
  for the purpose of just-in-time(JIT) compilation of HunterMatrix
...
- Enhancements to the clambc command line utility to assist
  HunterMatrix bytecode signature authors by providing introspection
  into compiled bytecode programs.
- Resolution of many of the warning messages from HunterMatrix compilation.
- Improved detection of malicious PE files.
- Security fix for HunterMatrix crash when using 'clamscan -a'. This issue
  was identified by Kurt Siefried of Red Hat.
- Security fix for HunterMatrix crash when scanning maliciously crafted
  ...
  Oppida.
- HunterMatrix 0.98.5 now works with OpenSSL in FIPS compliant mode.
  Thanks to Reinhard Max for supplying the patch.
- Bug fixes and other feature enhancements. See Changelog or
  git log for details.

Thanks to the following HunterMatrix community members for code submissions
and bug reporting included in HunterMatrix 0.98.5:
...
HunterMatrix 0.98.4 is a bug fix release. The following issues are now resolved:
...
Here are the new features and improvements in HunterMatrix 0.98.2:

- Support for common raw disk image formats using 512 byte sectors,
  specifically GPT, APM, and MBR partitioning.
- Experimental support of OpenIOC files. HunterMatrix will now extract file
  hashes from OpenIOC files residing in the signature database location,
  and generate HunterMatrix hash signatures. HunterMatrix uses no other OpenIOC
  ...
  about OpenIOC.
- All HunterMatrix sockets (clamd, freshclam, huntermatrix-milter, clamdscan, clamdtop)
  now support IPV6 addresses and configuration parameters.
- Use OpenSSL file hash functions for improved performance. OpenSSL
  is now prerequisite software for HunterMatrix 0.98.2.
...
- Change to circumvent possible denial of service when processing icons within
  ...
  Joxean Koret.
- Improvements to the fidelity of the HunterMatrix pattern matcher, an issue
...
- Opt-in collection of statistics. Statistics collected are: sizes and MD5
  ...
  parameter.
- Improvements to HunterMatrix build process, unit tests, and platform support with
...
- HunterMatrix 0.98.2 also includes miscellaneous bug fixes and documentation
  improvements.

Thanks to the following HunterMatrix community members for sending patches or reporting
bugs and issues that are addressed in HunterMatrix 0.98.2:
...
HunterMatrix 0.98.1 provides improved support of Mac OS X platform, support for new file types, and
...
- Various improvements to HunterMatrix configuration, support of third party libraries,
  and unit tests.

## 0.98

HunterMatrix 0.98 includes many new features, across all the different components
of HunterMatrix. There are new scanning options, extensions to the libhuntermatrix API,
...
- Signature improvements: New signature targets have been added for
  ...
  compatibility issues. For more details read the HunterMatrix Signatures
  guide.
...
- Authenticode: HunterMatrix is now aware of the certificate chains when
...
- New options: Several new options for clamscan and clamd have been
  added. For example, HunterMatrix can be set to print infected files and
...
- New callbacks added to the API: The libhuntermatrix API has additional hooks
  for developers to use when wrapping HunterMatrix scanning. These function
  ...
  library. For more details refer to the huntermatrix.h file.
...
--
The HunterMatrix team (https://www.huntermatrix.net/about.html#credits)

## 0.97.8

HunterMatrix 0.97.8 addresses several reported potential security bugs. Thanks to
Felix Groebert of the Google Security Team for finding and reporting these
issues.

## 0.97.7

HunterMatrix 0.97.7 addresses several reported potential security bugs. Thanks to
Felix Groebert, Mateusz Jurczyk and Gynvael Coldwind of the Google Security
Team for finding and reporting these issues.

## 0.97.6

HunterMatrix 0.97.6 includes minor bug fixes and detection improvements.
HunterMatrix 0.97.6 corrects bug 5252 "CL_EFORMAT: Bad format or broken data ERROR
reported as scan result."

## 0.97.5

HunterMatrix 0.97.5 addresses possible evasion cases in some archive formats
...
HunterMatrix 0.97.4 includes minor bugfixes, detection improvements and initial
support for on-access scanning under Mac OS X (see contrib/ClamAuth).
This update is recommended for all users.

## 0.97.3

HunterMatrix 0.97.3 is a minor bugfix release and is recommended for all
users. Please refer to the ChangeLog file for details.

## 0.97.2

HunterMatrix 0.97.2 fixes problems with the bytecode engine, Safebrowsing detection,
...
HunterMatrix 0.97 brings many improvements, including complete Windows support
...
https://wiki.huntermatrix.net/Main/UpgradeNotes097

With Sourcefire, Inc. acquisition of Immunet Corp., HunterMatrix for Windows
3.0 has been renamed Immunet 3.0, powered by HunterMatrix. This release
contains the fully integrated LibHunterMatrix 0.97 engine for offline,
OnDemand, and OnAccess scanning. Immunet 3.0 users can now utilize
the full power of the LibHunterMatrix engine, all the HunterMatrix signatures,
and creation of custom signatures on any platform running Immunet 3.0,
powered by HunterMatrix. If you run Windows systems in your environment and
need an AV solution to protect them, give Immunet 3.0, powered by HunterMatrix
a try; you can download it from https://www.huntermatrix.net/download.html#otherversions
...
HunterMatrix 0.96.5 includes bugfixes and minor feature enhancements, such as
...
HunterMatrix 0.96.4 is a bugfix release recommended for all users.
...
HunterMatrix 0.96.2 brings a new PDF parser, performance and memory improvements,
...
This release of HunterMatrix introduces new malware detection mechanisms and other
significant improvements to the scan engine. The key features include:

- The Bytecode Interpreter: the interpreter built into LibHunterMatrix allows
...
- Heuristic improvements: improve the PE heuristics detection engine by
  ...
  nutshell, HunterMatrix can now detect malware that tries to disguise itself
...
- Support for new archives: 7zip, InstallShield and CPIO. LibHunterMatrix
...
- Native Windows Support: HunterMatrix will now build natively under Visual
  Studio. This will allow 3rd Party application developers on Windows
  to easily integrate LibHunterMatrix into their applications.

The complete list of changes is available in the ChangeLog file. For upgrade
notes and tips please see: https://wiki.huntermatrix.net/Main/UpgradeNotes096
...
HunterMatrix 0.95.3 is a bugfix release recommended for all users.
...
HunterMatrix 0.95 introduces many bugfixes, improvements and additions. To make
the transition easier, we put various tips and upgrade notes on this page:
https://wiki.huntermatrix.net/Main/UpgradeNotes095. For detailed list of changes
...
- Google Safe Browsing support: in addition to the heuristic and signature
  based phishing detection mechanisms already available in HunterMatrix, the
  scanner can now make use of the Google's block lists of suspected
  phishing and malware sites. The HunterMatrix Project distributes a constantly
  ...
  https://docs.huntermatrix.net/faq/faq-safebrowsing.html.

- New huntermatrix-milter: The program has been redesigned and rewritten from
...
- Improved API: The API used to program HunterMatrix's engine (libhuntermatrix) has
...
- Memory Pool Allocator: Libhuntermatrix now includes its own memory pool
...
- Unified Option Parser: Prior to version 0.95 each program in HunterMatrix's
...
HunterMatrix 0.94.1 fixes some issues that were found in previous releases and
includes one new feature, "Malware Statistics Gathering." This is an optional
feature that allows HunterMatrix users optionally to submit statistics to us about
...
area they are. It will also allow us to publish summary data on www.huntermatrix.net
...
Sourcefire and the HunterMatrix team are pleased to announce the release of
HunterMatrix 0.94. The following are the key features and improvements of this
version:
...
- Anti-phishing Technology: Users can now change the priority and reporting
  of HunterMatrix's heuristic anti-phishing scanner within the detection engine
  process. They can choose whether, when scanning a suspicious file, HunterMatrix
...
- Disassembly Engine: The initial version of the disassembly engine improves
  HunterMatrix's detection abilities.
...
** serious problems with HunterMatrix builds under Cygwin due to some low-level
** incompatibilities in the POSIX compatibility layer, resulting in unreliable
** HunterMatrix behaviour.
...
- freshclam:
  ...
  - main.inc and daily.inc directories are no longer used by HunterMatrix; please
...
SFX-ARJ archives, AutoIt, basic SPF parser in huntermatrix-milter (to reduce
...
libhuntermatrix now includes the regex library from OpenBSD.
...
This release fixes various bugs in libhuntermatrix, freshclam and huntermatrix-milter,
and adds support for PUA (Potentially Unwanted Application) signatures
(clamscan: --detect-pua, clamd: DetectPUA).

** Announcement **

Dear HunterMatrix users,

On August 17, Sourcefire, the creators of Snort, acquired the HunterMatrix project.
The full announcement is available here:

http://www.sourcefire.com/products/huntermatrix/

We'd like to thank everyone in the HunterMatrix community for their dedication to
the project. The acquisition by Sourcefire is a testament to the hard work of
the entire HunterMatrix community in developing cutting edge technology that truly
...
continue the advancement of HunterMatrix.

Sourcefire now owns HunterMatrix project and related trademarks, as well as the
source code copyrights held by the five principal members of the HunterMatrix team.
Sourcefire will also assume control of the HunterMatrix project including: the
HunterMatrix.org domain, web site and web site content; and the HunterMatrix Sourceforge
project page.
...
continued efforts to advance the HunterMatrix technology and improve our ability to
interact with the open source community. The core team will continue to lead
the advancement of HunterMatrix and the CVD as employees of Sourcefire. Both the
HunterMatrix engine and the signature database will remain under GPL.
...
HunterMatrix 0.91 is the first release to enable the anti-phishing technology
...
- libhuntermatrix.dll available under Windows
- IPv6 support in huntermatrix-milter
...
This release fixes some security bugs in libhuntermatrix and improves stability
...
This release fixes many problems in libhuntermatrix and freshclam.
...
The HunterMatrix team is proud to announce the long awaited HunterMatrix 0.90.
...
./configure when compiling HunterMatrix. The experimental code introduces many
improvements in terms of detection rate and performances. If you find a bug,
please take some time to report it on our bugzilla: https://bugzilla.huntermatrix.net.
...
and others. Additionally, HunterMatrix now includes better mechanisms for scanning
...
phishing emails. The HunterMatrix phishing module allows better and more generic
...
(https://www.huntermatrix.net/nodalcore/) is now available in HunterMatrix and will be
...
We are happy to announce new interesting software with support for HunterMatrix:

- AqMail - a POP3 client with additional filtering
- ClamFS - a FUSE-based file system with on-access anti-virus scanning
- c-icap - an ICAP server coded in C with support for HunterMatrix
- MailCleaner - a complete email filtering gateway
- mod_streamav - a HunterMatrix based antivirus filter for Apache 2
- pyClamd - a python interface to Clamd

More information at https://www.huntermatrix.net/download.html#tools
...
The HunterMatrix developers encourage all users to give a try to the latest
...
such incidents in the future, every new HunterMatrix package will be released
...
in libhuntermatrix, improved scanning of Cabinet and FSG compressed files, better
database handling in huntermatrix-milter, and others.
...
been fixed in libhuntermatrix. Database reloading in huntermatrix-milter has been improved.
...
one or more of which was empty, could crash libhuntermatrix has been fixed. Other
...
- 3rd party software:
  ...
  - SmarterMail Filter - HunterMatrix based plugin for SmarterMail Mail Server
  - smf-clamd - small & fast virus filter for Sendmail
  - Squidclam - replacement for SquidHunterMatrix-Redirector.py written in C
  - QtHunterMatrixclient - remote clamd client based on the Qt Toolkit
...
[...]
Support for Sensory Networks' NodalCore acceleration in HunterMatrix will be
available in version 0.90 of the software suite in Q3 2005. For more
information please visit:
http://www.sensorynetworks.com/

The HunterMatrix project announces the opening of the official merchandise store:

http://www.cafepress.com/huntermatrix/
...
By purchasing our merchandise, you contribute to the development of HunterMatrix.
...
a stability problem of huntermatrix-milter/clamd and improves e-mail scanning.
...
was greatly enhanced. huntermatrix-milter by default uses libhuntermatrix and scans emails
itself without the use of clamd. libhuntermatrix can now extract RFC2397 encoded
...
- clamd:
  - new directive ExitOnOOM (stop the daemon when libhuntermatrix reports an out of
    memory condition)
...
- huntermatrix-milter:
  - by default uses libhuntermatrix to scan e-mails
...
- The list of third party programs with support for HunterMatrix is growing
  rapidly. Here are the latest additions (see clamdoc.pdf for details):

  - AVScan - a libhuntermatrix based GUI a-v scanner for Unix
  - clamailfilter - a Python script that provides a-v scanning via procmailrc
  - HunterMatrixPlugin - A HunterMatrix plugin for SpamAssassin 3.x
  ...
  - ClamTk - a perl-tk GUI for HunterMatrix
  - clapf - a virus scanning and antispam content filter for Postfix
  - D bindings for HunterMatrix - HunterMatrix bindings for the D programming language
  - Frox - a transparent FTP proxy
  - KMail - a fully-featured email client now supports HunterMatrix out of box
  ...
  - php-huntermatrix - scan files from within PHP
  - pymavis - a powerful email parser, similar to the old amavis-perl
  - QClam - a simple program to plug HunterMatrix to a qmail mailbox
  - qmailmrtg7 - display graphs of viruses found by HunterMatrix
  ...
  - snort-inline - scan your network traffic for viruses with HunterMatrix
  - SquidHunterMatrix Redirector - a Squid helper script which adds virus scanning
...
to use db.XY.huntermatrix.net where XY is your country code (see
http://www.iana.org/cctld/cctld-whois.htm for the full list). Please add
the following lines to freshclam.conf:

    DNSDatabaseInfo current.cvd.huntermatrix.net
    DatabaseMirror db.XY.huntermatrix.net
    DatabaseMirror database.huntermatrix.net
...
The development version of HunterMatrix is ready for general testing! New mechanisms
...
signatures added by the HunterMatrix database maintainers. That means servers running
the new version of HunterMatrix have detected and blocked 100% of Mydoom attacks!
...
- clamd
  ...
  - new directive ArchiveBlockMax (archives that exceed limits will be
    marked as viruses)
  - huntermatrix.conf was renamed clamd.conf
...
- freshclam:
  - new directive DNSDatabaseInfo that enables ultra lightweight version
    ...
    (see http://www.gossamer-threads.com/lists/huntermatrix/users/11102)
...
- configure:
  - new option --disable-gethostbyname_r (try enabling it if huntermatrix-milter
    compilation fails)
...
- new 3rd party software with support for HunterMatrix:
  ...
  - BeClam - HunterMatrix port for BeOS
  - clamXav - a virus scanner with GUI for Mac OS X

Special thanks to aCaB for his work on UPX, FSG and Petite decompressors.

Thanks to good reaction times on new threats HunterMatrix was awarded as best
security tool for 2004 by Linux Journal: "...With this year's outbreak of
e-mail worms for non-Linux platforms, HunterMatrix has been getting quite a workout,
...
HunterMatrix. Wear them and virus writers will stay away from you :- A quarter out
of every dollar profited from the sale of these shirts will go to the HunterMatrix
project. Visit http://www.sourcewear.com and click on HunterMatrix logo!
...
Important notice for people using HunterMatrix 0.60:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Our logs show that there is still a small percentage of HunterMatrix 0.60
installations updating their database. HunterMatrix 0.60 was released on
July 29th, 2003 and it was the last release to use the old database
format. Starting from version 0.65, released on November 12nd, HunterMatrix
...
we plan to drop support for HunterMatrix 0.60 on September 1st.

We encourage _all_ users to upgrade to the latest release available.
People running an old version of HunterMatrix are missing many viruses and
...
of mail scanning and huntermatrix-milter and clamdscan behaviour.
...
New members of our "3rd party software" list:
  ...
  - pyhuntermatrix           Python binding for HunterMatrix
...
Japanese users can take an advantage of the new HunterMatrix related site:
    http://huntermatrix-jp.sourceforge.jp/
and join the huntermatrix-jp-users mailing list.
...
Thank you for using HunterMatrix !
...
- clamscan:
  - automatically decide (by comparing daily.cvd version numbers) which
    database directory (hardcoded or huntermatrix.conf's one) to use
  ...
  - respect --tempdir in libhuntermatrix
...
- documentation:
  - new Polish documentation on HunterMatrix and Samba integration
...
database.huntermatrix.net. Our DNS servers can answer with a CNAME to:
db.europe.huntermatrix.net, db.america.huntermatrix.net, db.asia.huntermatrix.net or
db.other.huntermatrix.net. Our advanced push-mirroring mechanism (maintained by
...
We are happy to announce new programs with support for HunterMatrix (all of them
have been reviewed by our team - more info in the documentation and
on our website: https://www.huntermatrix.net/download.html#tools):

- ClamWin - a GUI for Windows (!)
- KlamAV - a collection of GUI tools for using HunterMatrix on KDE
- clamscan-procfilter - a Perl procmail filter
- j-chkmail - a powerful filter for sendmail
- qscanq - Virus Scanning for Qmail
- huntermatrixr - a Ruby binding for HunterMatrix
...
- mailman-huntermatrix - a virus filter for Mailman
- wbmhuntermatrix - a webmin module to manage HunterMatrix
- Scan Log Analyzer
...
This version is a response to the "huntermatrix 0.65 remote DOS exploit" information
...
- huntermatrix-milter: (Nigel Horne)
...
- freshclam:
  - support for freshclam.conf (that may be optionally merged with
    huntermatrix.conf, command line options overwrite config settings)
...
- documentation:
  ...
  - Polish how-to on HunterMatrix and Sendmail integration (with huntermatrix-milter)
    by Przemyslaw Holowczyc

News:

HunterMatrix was the first anti-virus protecting against Worm.SCO.A (aka MyDoom.A) !
...
huntermatrix-devel is finally able to decode OLE2 (Microsoft Office) files and
decompress VBA streams ! The code is developed by Trog, official HunterMatrix
...
hard work on daily submissions and forcing us to keep HunterMatrix quality on
the highest possible level.

New mirroring mechanisms. Luca Gibelli (HunterMatrix) and mirror administrators
...
--
Tomasz Kojm <tkojm*huntermatrix.net>
February 10, 2004

## 0.65

IMPORTANT NOTE: The project has been moved into SourceForge. The only official
HunterMatrix's homepage is www.huntermatrix.net (however huntermatrix.elektrapro.
com still works). We would like to thank ElektraPro.com for
their support for the open-source community  - THANKS !

HunterMatrix 0.65 introduces a new database container file format (called CVD) with
...
details in clamdoc.pdf. If you want to become an official HunterMatrix mirror
(with entry in database.huntermatrix.net) please read the huntermatrix-mirror-howto.pdf
document and contact our administrator - Luca Gibelli <nervous*huntermatrix.net>.
...
- huntermatrix-milter: (Nigel Horne <njh*huntermatrix.net>)
  - new --force-scan flag
  - new -P and -q flags by Nicholas M. Kirsch
    WARNING: huntermatrix-milter and our mail scanner are still in high development
...
- freshclam:
  ...
  - rewritten to use database.huntermatrix.net and CVD

- documentation:
  - new Spanish documentation on HunterMatrix and Sendmail integration by
    Erick Ivaan Lopez Carreon
  - included clamdoc.pdf Turkish translation by yavuz kaya and �brahim erken
  - included huntermatrix-mirror-howto.pdf by Luca Gibelli
  - included clamd+daemontools HOWTO by Jesse D. Guardiani
  - included signatures.pdf
  - man pages: updated
  - clamdoc.pdf: rewritten

New members of our list of HunterMatrix certified software (see clamdoc.pdf for
details):
  - cgpav
  - smtp-vilter
  - IVS Milter
...
huntermatrix-milter written by HunterMatrix developer Nigel Horne. This is a mail scanner
...
performance is required. Please check clamdoc for more detail.
    ...
    Many people get confused with HunterMatrix database status because of
    the OpenAntiVirus update information at:
    http://openantivirus.org/latest.php
    (last update at 17 October, 2002). The HunterMatrix virus database contains
    ...
    http://huntermatrix.elektrapro.com/doc/signatures.pdf

News from HunterMatrix world:

- New email address for virus submitting: virus@huntermatrix.elektrapro.com
...
- New mailing list: virusdb@huntermatrix.elektrapro.com
   After each update an email with subject "[huntermatrix-virusdb] Update" and a list
...
- New official mirrors:
  - huntermatrix.ozforces.com: database mirror updated manually (thanks to
    Andrew <andrew@ozforces.com>)
  - huntermatrix.essentkabel.com: full (automatic) mirror of huntermatrix.elektrapro.com
    (thanks to Chris van Meerendonk <cvm@castel.nl>)
  - huntermatrix.linux-sxs.org: database mirror - rsync from huntermatrix.ozforces.com
...
- there are many new programs that use HunterMatrix, eg. mod_huntermatrix (Apache
...
- clamd:
  ...
  - new STREAM command (scanning data on socket) and directives:
    ...
    sent from another host), currently only huntermatrix-milter uses this.
...
- libhuntermatrix:
  - fixed segfault with some strange zip archives (there is a bug in zziplib,
    libhuntermatrix contains a work around for it) (the problem was reported by
...
- configure:
  - allow configuration of the huntermatrix user and group with --with-user and
...
- freshclam:
  - applied http-proxy patch from http://bugs.debian.org/huntermatrix (by
...
- limited memory usage (at the cost of speed, increase CL_MIN_LENGTH in
  libhuntermatrix/huntermatrix.h to make it faster, it's safe to set it on 3-4 for
  the OAV database)
...
Here it is...
Clam AntiVirus 0.50 contains an anti-virus library - libhuntermatrix, a fully
...
available - you can subscribe via www at http://huntermatrix.elektrapro.com/ml.
Please check the manual for more information.

New software:

- libhuntermatrix with RAR, Zip and Gzip support built-in. The library is thread
  ...
  included and slightly modified in the huntermatrix sources. You need the zlib
  library for the Zip/Gzip support, though. The API is described with
  examples in the clamdoc.

- clamd: a modern anti-virus daemon. It uses configuration file huntermatrix.conf
  described in the huntermatrix.conf(5) manual. The program was written with
  security as a goal.
...
- clamscan: Nigel Horne <njh@bandsman.co.uk> has added the ability to scan
  ...
  libhuntermatrix and allow clamd using it. Please check support/mboxscan, also.
...
- clamscan: use libhuntermatrix's archive support by default (it's enabled by default
  and may be disabled with --disable-archive) and switch to the external
  unpackers (if specified) in the case of libhuntermatrix archive code error.
...
- freshclam: --daemon-notify. freshclam will send the RELOAD command to the
  ...
  huntermatrix.conf to determine the socket type).
...
- new man pages: clamd(1), huntermatrix.conf(5); others updated
...
has generated over 200 new signatures, HunterMatrix's database is also frequently
...
least ;). HunterMatrix 0.50 was tested on Linux and Solaris and should work fine.
...
New HunterMatrix version is in a heavy development. It has currently built-in
...
archives unaccessible directly by the huntermatrix user are copied (with a respect to
...
- removed eicar test files and logos from the documentation due to the GPL
  (thanks for Magnus Ekdahl <magnus@debian.org>), HunterMatrix-Test-Signature is
  used instead
- removed Qmail-Scanner patch, HunterMatrix is supported by Q-S 1.13 (thanks guys!)
- code cleanups
...
HunterMatrix 0.21 source package contains initial support for NetBSD
...
<grantma@anathoth.gen.nz> and it will be the primary updater for HunterMatrix
...
released just today. In the next 2 months, huntermatrix development will be much
...
- http://huntermatrix.elektrapro.com
