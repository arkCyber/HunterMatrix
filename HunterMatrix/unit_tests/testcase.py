...
"""
Wrapper for unittest to provide HunterMatrix specific test environment features.
"""
...
class TestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.check_huntermatrix =     Path(os.getenv("CHECK_HUNTERMATRIX"))     if os.getenv("CHECK_HUNTERMATRIX") != None else None
        ...
        cls.milter =           Path(os.getenv("HUNTERMATRIX_MILTER"))    if os.getenv("HUNTERMATRIX_MILTER") != None else None
        ...
        # cls.log.info(f"  check_huntermatrix:      {cls.check_huntermatrix}")
    ...
    def verify_valgrind_log(self, log_file: Union[Path, None]=None):
        ...
        try:
            ...
            self.log.warning('Please submit this log to https://github.com/Cisco-Talos/huntermatrix/issues:'.center(69, ' '))
