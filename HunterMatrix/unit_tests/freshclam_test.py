...
class TC(testcase.TestCase):
    ...
    def test_freshclam_01_file_copy(self):
        self.step_name('Basic freshclam test using file:// to "download" huntermatrix.hdb')
        ...
        '''.format(
            freshclam_pid=TC.freshclam_pid,
            path_db=TC.path_db,
            file_db=TC.path_www / "huntermatrix.hdb",
            port=TC.mock_mirror_port,
        ...
        expected_stdout = [
            'Downloading huntermatrix.hdb',
            'Database test passed.',
            'huntermatrix.hdb updated',
        ]
    ...
    def test_freshclam_05_cdiff_update_UNC(self):
        # This is a regression test for https://github.com/Cisco-Talos/huntermatrix/pull/226
...
class WebServerHandler_02(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if 'Range' in self.headers:
            ...
            page =b'HunterMatrix-VDB:21 Sep 2020 09-52 -0400:25934:4320797:63:2ee5a3e4285b496656117ae3809b6040:gMj7NXhxfew0+bToOF8GX7xPHPGXhOSD+CSuf3E7SHhLmVZCJUVhPS01h42I0W1py7L+BmM2yhPIW8t/oGPFw8+hdD4DU/ceET15wnPWU4lsJJeRkl46Z4D8INe9Oq36ixT1xEIkERogPE3qr6wszmjT2Xe2VcmydTXN2GfPQX:raynman:1600696324                                                                                                                                                                                                                                               '
        else:
