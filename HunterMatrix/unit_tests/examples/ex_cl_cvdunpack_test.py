...
class TC(testcase.TestCase):
    ...
    def setUpClass(cls):
        ...
        if operating_system == 'windows':
            # Windows needs the example program to be in the same directory as libhuntermatrix and the rest.
            shutil.copy(
            ...
            # Linux and macOS can use the LD_LIBRARY_PATH environment variable to find libhuntermatrix
